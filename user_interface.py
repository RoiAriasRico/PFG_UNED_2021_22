...
class App(tk.Tk):
    def __init__(self):
        ...
        for F in {HomePage, Visualizacion, Limpieza, NER, Herramientas, Clasificacion, res_Final}:
...
class HomePage(tk.Frame):
    ...
    def __init__(self, parent, container):
        ...
        rb5 = Radiobutton(frame, text="Resultados finales", variable=self.var_system, command = lambda: parent.show_frame(parent.Final),
...
class Clasificacion(tk.Frame):
    ...
    def __init__(self, parent, container):
        ...
        boton3.place(rely=0.35, relx=0.85)
